...
export default function PDFToAudio({ documentId: _documentId }: PDFToAudioProps) {
  ...
  const getSourceLabel = (source: string): string => {
    switch (source) {
      ...
      case 'ferrari': return '📚 Book Publishing House';
    ...
    <div className="space-y-6">
      <div className="space-y-4">
          ...
          {allPDFs.length === 0 ? (
            <div className="p-4 bg-gray-50 border border-gray-200 rounded">
              <p className="text-sm text-gray-600">
                No documents available. Upload a PDF or TXT file, or generate one using Book Publishing House or Book Writer.
              </p>
            </div>
          ) : (
            <select
            ...
            >
              ...
              {ferrariProjects.length > 0 && (
                <optgroup label="📚 Book Publishing House Books">
                  {ferrariProjects.map((proj) => (
        ...
        <div className="p-6 bg-gray-50 border border-gray-200 rounded">
          <h3 className="font-semibold text-base mb-3">ℹ️ About Document to Audio Conversion</h3>
          <ul className="list-disc list-inside space-y-2 text-sm text-gray-700">
            <li>Upload PDF or TXT files directly, or use documents generated by Book Publishing House / Book Writer</li>
            <li>Uses Bark TTS by Suno AI - high-quality text-to-audio model</li>
            <li>Converts entire documents to audio format</li>
            <li>TXT files are processed directly without text extraction (faster)</li>
